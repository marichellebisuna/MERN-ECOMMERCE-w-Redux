...
export const COUPON_SEARCH_FAIL = 'COUPON_SEARCH_FAIL';
export const COUPON_SEARCH_RESET = 'COUPON_SEARCH_RESET';

export const COUPON_COUNT_REQUEST = 'COUPON_COUNT_REQUEST';
export const COUPON_COUNT_SUCCESS = 'COUPON_COUNT_SUCCESS';
export const COUPON_COUNT_FAIL = 'COUPON_COUNT_FAIL';
export const COUPON_COUNT_RESET = 'COUPON_COUNT_RESET';
